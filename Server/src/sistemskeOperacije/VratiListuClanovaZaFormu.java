...
public class VratiListuClanovaZaFormu extends GlavnaSistemskaOperacija {

    public VratiListuClanovaZaFormu() {
        super();
    }
    ...
    protected ServerskiOdgovor commitOperation(DomenskiObjekat dom) throws Exception {
        ...
        try {
            ...
            so.setOdgovor(lista);
            so.setOperacija(Operacija.VRATI_CLANOVE_ZA_UNOS_FORMU);
