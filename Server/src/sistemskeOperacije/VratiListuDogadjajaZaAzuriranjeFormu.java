...
public class VratiListuDogadjajaZaAzuriranjeFormu extends GlavnaSistemskaOperacija {

    public VratiListuDogadjajaZaAzuriranjeFormu() {
        super();
    }
    ...
    protected ServerskiOdgovor commitOperation(DomenskiObjekat dom) throws Exception {
        ...
        try {
            ...
            so.setOdgovor(lista);
            so.setOperacija(Operacija.VRATI_DOGJADJAJE_ZA_AZURIRANJE_FORMU);
